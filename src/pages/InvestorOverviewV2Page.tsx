...
const TAB_DATA: Record<number, { label: string; href?: string; pdf?: string }[]> = {
  0: [
    ...
    { label: 'Annual Accounts of Subsidiaries & JVs', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/Annual-Accounts-of-Subsidiaries/9853GOPLFinancials17-18-min.pdf' },
  ...
  1: [
    ...
    { label: 'BSE & NSE', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/2022/02/03-01-2022-NSEBSE.pdf' },
    { label: 'Analyst Coverage', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/notice/2960GranulesIndiaConferenceCall,HostedbyEdelweissSecurities-June02....pdf' },
    { label: 'Buyback 2022', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/2022/10/Post-Buyback-Public-Announcement.pdf' },
    { label: 'Buyback 2020', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/notice/4531Buyback-Granules.pdf' },
  ...
  2: [
    { label: 'Financial Highlights', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/2022/05/FinancialResult18.05.2022.pdf' },
  ...
  3: [
    ...
    { label: 'Schedule Of Investor Meet', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/notice/8938IntimationofScheduleoftheNonDealRoadShow.pdf' },
    { label: 'Newspaper Publications', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/2342GranulesIndiaLimited-DispatchAdvertisement.pdf' },
  ...
  4: [
    ...
    { label: 'Transfer of Physical Shares in Demat Mode only', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/1121TransferofPhysicalSharesinDematModeonly.pdf' },
    ...
    { label: 'EGM voting results', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/2202EGMvotingresults.pdf' },
    { label: '24th AGM Voting Results', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/185924thAGMVotingResults.pdf' },
    ...
    { label: 'BSE Approval -Part B reg. Scheme of Amalgamation', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/5329BSEApproval-PartBregSchemeofAmalgamation.pdf' },
    { label: 'High Court Order of Amalgamation', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/3913HighCourtOrderofAmalgamation.pdf' },
    { label: 'Oral order of Amalgamation', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/4106OralorderofAmalgamation.pdf' },
    { label: 'Outcome of 23rd AGM of Granules India Limited', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/5667Outcomeof23rdAGMofGranulesIndiaLimited.pdf' },
    { label: 'NSE Observation Letter', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/4679NSEObservationLetter.pdf' },
    { label: 'BSE Observation Letter', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/3280BSEObservationLetter.pdf' },
    { label: 'Reply to Bombay Stock Exchange', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/6708ReplytoBombayStockExchange.pdf' },
    { label: 'Clause 24(F) documents Complaint Report', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/3616Clause24FdocumentsComplaintReport.pdf' },
    { label: 'Scheme of Arrangement & Clause 24(f) documents', pdf: 'https://d16d47oyl512wy.cloudfront.net/pdfs/pdf/other-information/SchemeofArrangementClause24fdocuments.pdf' },
  ],
};
