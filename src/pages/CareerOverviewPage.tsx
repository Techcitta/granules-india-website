...
const DISCOVER_PATHS = [
  ...
  },
  {
    ...
    desc: 'Drive high-volume, high-quality production across state-of-the-art facilities with operational excellence and safety at the core.',
  },
  {
    id: 'quality',
    title: 'Quality & Regulatory',
    desc: 'Uphold uncompromising standards of compliance, data integrity, and global regulatory excellence.',
  },
  {
    id: 'commercial',
    title: 'Sales, Marketing, & Supply chain',
    desc: 'Connect life-saving medicines to global markets with seamless supply chain agility and strategic commercial partnerships.',
  },
  {
    id: 'enabling',
    title: 'Enabling Functions',
    desc: 'Empower our teams through HR, finance, digital transformation, legal, and operational leadership.',
  },
];
...
export default function CareerOverviewPage() {
  ...
  return (
    <div className="cp">
      ...
      {/* Discover Your Path Interactive Showcase Banner */}
      <section className="car-discover-section" aria-label="Discover Your Path at Granules">
        <div className="car-discover-banner">
          <img
            src="/assets/sustainability.webp"
            alt="Granules Solar Panels and Facility"
            className="car-discover-bg"
            loading="lazy"
            decoding="async"
          />
          <div className="car-discover-overlay" />
                    ...
                    <span className="car-discover-toggle" aria-hidden="true">
                      {isOpen ? (
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                          <circle cx="12" cy="12" r="11" fill="#1e488f" />
                          <path d="M7.5 12h9" stroke="#ffffff" strokeWidth="2.2" strokeLinecap="round" />
                        </svg>
                      ) : (
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                          <circle cx="12" cy="12" r="11" fill="#e2edf9" />
                          <path d="M12 7.5v9M7.5 12h9" stroke="#1e488f" strokeWidth="2.2" strokeLinecap="round" />
                        </svg>
                      )}
                    </span>
                  </button>
