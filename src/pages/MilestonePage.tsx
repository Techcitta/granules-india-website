...
const MILESTONES: MilestoneEntry[] = [
  ...
  { year: '2026', image: '2026.jpg?v=2', caption: 'Expanded innovation capabilities through new R&D centres at IIT Hyderabad dedicated to peptide development and particle engineering' },
];
