...
export default function CookieConsent() {
  ...
  return (
    <div className="cookie-modal-overlay" role="dialog" aria-modal="true" aria-label="Cookie Preferences">
      <div className="cookie-popup-card">
        ...
        <p className="cookie-popup-desc">
          We use cookies to improve your browsing experience, analyze site usage, and support our marketing efforts. By clicking &quot;Accept&quot;, you agree to the storing of cookies on your device. You can review our full policy anytime in our{' '}
          <Link to="/cookie-policy" className="cookie-popup-link">Cookie Policy</Link>.
        </p>
