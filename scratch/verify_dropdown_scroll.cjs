...
(async () => {
  ...
  if (secResources) {
    ...
    // Scroll inside the custom dropdown list
    const scrollContainer = await page.$('.inv-custom-dropdown-scroll');
    if (scrollContainer) {
    ...
    await page.screenshot({
      path: 'C:/Users/ADMIN/.gemini/antigravity-ide/brain/a873e441-b7ff-4064-b6c5-8caa173f5b9c/investor_resources_categories_scrolled.png'
    });
